...
test.describe('Navigation & Routing', () => {
  ...
  test('scroll to portfolio section on homepage', async ({ page }) => {
    ...
    await page.locator('header nav button:has-text("Portfolio"), header nav button:has-text("포트폴리오")').first().click();
  ...
  test('can navigate home from other pages', async ({ page }) => {
    ...
    await page.locator('header nav button:has-text("Home"), header nav button:has-text("홈")').first().click();
