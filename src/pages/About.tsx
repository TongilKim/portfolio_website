    ...
    <main className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none mb-16">
          <h2 className="text-2xl font-bold mb-6">{t("aboutPage.story.title")}</h2>
          {(t("aboutPage.story.paragraphs", { returnObjects: true }) as string[]).map((paragraph, index) => (
        ...
        {/* Values section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-8 text-center">{t("aboutPage.valuesTitle")}</h2>
        ...
        {/* Skills section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-6 text-center">{t("aboutPage.skillsTitle")}</h2>
