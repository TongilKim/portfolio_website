      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div key={index} className="relative">
                ...
                {index < phases.length - 1 && (
                  <div className="absolute left-6 top-16 w-0.5 h-[calc(100%+1rem)] bg-blue-100 hidden md:block" />
                )}
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div className="flex-1 pb-8">
                    ...
                    <div className="bg-blue-50 rounded-lg p-4">
                      ...
                      <p className="text-gray-700">{phase.clientExperience}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-16 bg-gray-50 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {(t("process.timeline.items", { returnObjects: true }) as { type: string; duration: string }[]).map((item, index) => (
