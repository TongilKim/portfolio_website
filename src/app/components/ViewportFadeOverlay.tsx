...
export function ViewportFadeOverlay() {
	...
	return (
		<>
			{/* Top fade overlay - hidden when at top of page */}
			<div
				className="fixed top-0 left-0 right-0 h-48 pointer-events-none z-40 transition-opacity duration-300"
				style={{
			...
			{/* Extra height on mobile (h-64) to account for browser chrome hiding/showing */}
			<div
				className="fixed bottom-0 left-0 right-0 h-64 md:h-48 pointer-events-none z-40 transition-opacity duration-300"
				style={{
